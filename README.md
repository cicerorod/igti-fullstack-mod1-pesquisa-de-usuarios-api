...
<p align="center">
  WebSite: https://mod1-pesquisa-de-usuarios-api.vercel.app/
...
1. Clonar via prompt de comando o projeto em uma pasta de sua preferência: `git clone https://github.com/cicerorod/igti-fullstack-mod1-pesquisa-de-usuarios-api.git`
2. Acessar a pasta principal do projeto via prompt de comando. Ex: `cd igti-fullstack-mod1-pesquisa-de-usuarios-api`;
